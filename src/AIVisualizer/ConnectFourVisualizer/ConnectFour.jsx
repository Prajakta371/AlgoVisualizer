...
export default class ConnectFour extends Component {
    ...
    render() {
        let buttons =
            <>
                <button
                    style={{ position: "absolute", marginTop: "460px", marginLeft: "90px", height: "30px", width: "130px" }}
                ...
                <button
                    style={{ position: "absolute", marginTop: "460px", marginLeft: "240px", height: "30px", width: "70px" }}
                    onClick={() => this.undo()}
                    type="button"
                    class="btn btn-outline-dark">
